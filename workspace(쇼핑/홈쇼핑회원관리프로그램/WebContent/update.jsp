...
<section>
	...
	<form action="updatePro.jsp" method="post" name="f">
		<table border="1" width = "650" style="margin: 0 auto;">
			...
			<tr>
				<th>회원전화</th>
				<td><input type="text" name="phone" value="<%=rs.getString(3) %>" size="35" maxlength="13"></td>
			</tr>
			<tr>
				<th>회원주소</th>
				<td><input type="text" name="address" value="<%=rs.getString(4) %>" size="50" maxlength="60"></td>
			</tr>
			<tr>
				<th>가입일자</th>
				<td><input type="text" name="joindate" value="<%=rs.getString(5) %>" size="20" maxlength="6" readonly></td>
			</tr>
			<tr>
				<th>고객등급[A:VIP,B:일반,C:직원]</th>
				<td><input type="text" name="grade" value="<%=rs.getString(6) %>" size="20" maxlength="6"></td>
			</tr>
			<tr>
				<th>도시코드</th>
				<td><input type="text" name="city" value="<%=rs.getString(7) %>" size="20" maxlength="6"></td>
			</tr>
			<tr>
				<th colspan="2">
